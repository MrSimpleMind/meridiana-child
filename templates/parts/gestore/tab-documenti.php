...
<div class="tab-header">
    ...
    <button class="btn btn-primary" @click="openFormModal('documenti', 'new')"><i data-lucide="plus"></i> Nuovo Documento</button>
</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions-cell">
                    <button class="btn-icon" @click="openFormModal('documenti', 'edit', <?php echo get_the_ID(); ?>)" title="Modifica"><i data-lucide="edit-2"></i></button>
