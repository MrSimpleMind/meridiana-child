 ...
 * Mostra 2 convenzioni attive in un carousel orizzontale
 */

// Query: 2 convenzioni attive
...
<div class="convenzioni-carousel">
    ...
    <a href="<?php the_permalink(); ?>" class="convenzione-card">
        ...
        <div class="convenzione-card__content">
            ...
            <?php if ($descrizione): ?>
            <p class="convenzione-card__description"><?php echo esc_html(wp_trim_words($descrizione, 15)); ?></p>
            <?php endif; ?>
        </div>
    </a>
