...
(function() {
    ...
    const saluteListContainer = document.getElementById('saluteList');
    ...
    /**
     * Render salute with correct SCSS classes
     */
    function renderSalute(salute) {
        if (salute.length === 0) {
            saluteListContainer.innerHTML = '';
